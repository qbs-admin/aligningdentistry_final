...
<div class="mx-2 mx-md-5">
    <div class="row pt-2 pt-md-5">
        ...
        <div class="col-lg-8 x-3 mx-md-0">
            <div id="laser_dentistry" class="services_contents">
                <div class="mb-5">
                    ...
                    <ul class="list_points_ul">
                        ...
                        <li>In root canal treatment</li>
                        <li>To remove/reduce gum inflammation</li>
                        <li>Reshaping gums</li>
                        <li>Tongue-tie release</li>
                        <li>Canker sore & cold sore pain treatments</li>
                        <li>Biopsies</li>
                        <li>Exposing wisdom teeth</li>
                        <li>Biopsies</li>
                        <li>For damaged nerve regeneration</li>
